...
export default function ResultsView({ estimate, analysis, onRetry, onStartOver, onNeuro }) {
  useCss();
          ...
          <div className="rv-report-hd">
            ...
            {analysis.personalReport.source && (
              <span
                ...
                title={analysis.personalReport.source === 'ai' ? 'Generated by GLM 5.1' : 'Fallback template (GLM call failed)'}
              >
                {analysis.personalReport.source === 'ai' ? '● GLM 5.1' : '○ template'}
              </span>
            )}
          </div>
